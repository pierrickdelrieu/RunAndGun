...
class Terrain:
    def __init__ (self, tab_terrain, theme, fenetre):
        ...
        image_terre = [image_terre1, image_terre1, image_terre1]
        ...
        image_sol = [image_sol1, image_sol2, image_sol3]
        ...
        self.tuiles = {0 : image_terre, 1 : image_sol, 2 : image_vide, 3 : image_caisse, 4 : image_bonus}
    ...
    def rendu_terrain (self):
        ...
        for i in range (0, len(self.tab_terrain)):
            for j in range (0,len(self.tab_terrain[i])):
                ...
                self.fenetre.blit (random.choice (self.tuiles.get(self.tab_terrain[i][j])), (x,y)) #blit permet d'afficher qq chose sur la fenetre
