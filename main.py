...
def main(theme: str, id_niveau: int):
    ...
    joueurs = {
        1: [joueur1_corps, joueur1_bras, joueur1_energie, armes[0]],
        2: [joueur2_corps, joueur2_bras, joueur2_energie, armes[0]],
    }

    vie_gui = VieGUI(joueurs.get(1)[0], joueurs.get(2)[0])
    ...
    while joueurs.get(tour)[0].vie > 0:
        ...
        if not joueurs.get(tour)[0].is_shooting:
            ...
            if touche_presse[pg.K_a]:
                ...
                joueurs.get(tour)[3] = armes[selection]
